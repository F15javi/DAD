...
CREATE TABLE `fly` (
  ...
  CONSTRAINT `id_AirportDest` FOREIGN KEY (`id_Fly`) REFERENCES `airport` (`id_airport`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_AirportOrig` FOREIGN KEY (`id_Fly`) REFERENCES `airport` (`id_airport`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gps` (
  ...
  `time` time NOT NULL,
  PRIMARY KEY (`id_Gps`),
  CONSTRAINT `id_Fly` FOREIGN KEY (`id_Gps`) REFERENCES `fly` (`id_Fly`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-23 10:25:08
